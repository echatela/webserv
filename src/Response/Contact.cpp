...
Contact::Contact(std::string name, std::string phone, void *img)
...
std::string Contact::HandlePostResponse(HttpResponse &response)
{
	...
	response_body.append("\t<meta charset=\"utf-8\">\n");
